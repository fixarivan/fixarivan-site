...
function fixarivan_viewer_portal_ui(string $lang): array
{
    ...
    $all = [
        'ru' => [
            ...
            'thanks_title' => 'Спасибо, что обратились в FixariVan!',
            'thanks_body' => "Был рад помочь 😊\n\nЕсли у вас осталось хорошее впечатление о ремонте, буду очень благодарен за короткий отзыв в Google.\n\nДля небольшого сервиса это действительно очень важно и помогает развиваться.",
            'google_review_intro' => '⭐ Пожалуйста, поставьте 5 звёзд, если всё прошло отлично.',
            'google_review_stars' => '5 звёзд',
            'google_review_cta' => 'Оставить отзыв на Google',
            'prepay_modal_title' => 'Предоплата за запчасти',
            'prepay_modal_intro' => 'Для заказа запчастей нужна предоплата. Вы можете перевести сумму одним из способов ниже.',
            'prepay_amount' => 'Сумма к оплате',
            'prepay_mobilepay' => 'MobilePay',
            'prepay_mobilepay_hint' => 'Откройте приложение MobilePay и отправьте перевод на номер:',
            'prepay_bank' => 'Банковский перевод',
            'prepay_iban' => 'IBAN',
            'prepay_bic' => 'BIC',
            'prepay_recipient' => 'Получатель',
            'prepay_close' => 'Понятно',
            'prepay_open_btn' => '💳 Как оплатить запчасти',
            'prepay_paid_chip' => 'Предоплата за запчасти',
            'prepay_paid_banner' => 'Предоплата за запчасти получена',
        ],
        'en' => [
            ...
            'thanks_title' => 'Thank you for reaching out to FixariVan!',
            'thanks_body' => "I was glad to help 😊\n\nIf you're happy with the repair, I'd really appreciate a short Google review.\n\nFor a small shop like ours, it truly matters and helps us grow.",
            'google_review_intro' => '⭐ If everything went great, please leave 5 stars.',
            'google_review_stars' => '5 stars',
            'google_review_cta' => 'Leave a review on Google',
            'prepay_modal_title' => 'Parts prepayment',
            'prepay_modal_intro' => 'A prepayment is required to order parts. You can send the amount using one of the options below.',
            'prepay_amount' => 'Amount to pay',
            'prepay_mobilepay' => 'MobilePay',
            'prepay_mobilepay_hint' => 'Open the MobilePay app and send a payment to:',
            'prepay_bank' => 'Bank transfer',
            'prepay_iban' => 'IBAN',
            'prepay_bic' => 'BIC',
            'prepay_recipient' => 'Recipient',
            'prepay_close' => 'Got it',
            'prepay_open_btn' => '💳 How to pay for parts',
            'prepay_paid_chip' => 'Parts prepayment',
            'prepay_paid_banner' => 'Parts prepayment received',
        ],
        'fi' => [
            ...
            'thanks_title' => 'Kiitos, että otit yhteyttä FixariVaniin!',
            'thanks_body' => "Olin iloinen, että sain auttaa 😊\n\nJos korjaus jätti hyvän mielen, olisin erittäin kiitollinen lyhyestä Google-arvostelusta.\n\nPienelle yritykselle se on todella tärkeää ja auttaa kehittymään.",
            'google_review_intro' => '⭐ Jos kaikki sujui loistavasti, anna viisi tähteä.',
            'google_review_stars' => '5 tähteä',
            'google_review_cta' => 'Kirjoita arvostelu Googleen',
            'prepay_modal_title' => 'Osien ennakkomaksu',
            'prepay_modal_intro' => 'Osien tilaamiseen tarvitaan ennakkomaksu. Voit siirtää summan jollakin alla olevista tavoista.',
            'prepay_amount' => 'Maksettava summa',
            'prepay_mobilepay' => 'MobilePay',
            'prepay_mobilepay_hint' => 'Avaa MobilePay-sovellus ja lähetä maksu numeroon:',
            'prepay_bank' => 'Tilisiirto',
            'prepay_iban' => 'IBAN',
            'prepay_bic' => 'BIC',
            'prepay_recipient' => 'Saaja',
            'prepay_close' => 'Selvä',
            'prepay_open_btn' => '💳 Näin maksat osat',
            'prepay_paid_chip' => 'Osien ennakkomaksu',
            'prepay_paid_banner' => 'Osien ennakkomaksu vastaanotettu',
        ],
    ];
