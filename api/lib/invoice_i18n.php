...
function fixarivan_invoice_merge_for_form_one(string $lang): array
{
    $base = [
        'ru' => [
            ...
            'saved_link_invoice' => 'Счёт для клиента (просмотр):',
            'saved_link_portal' => 'Портал:',
            'copy_link' => 'Копировать URL',
            'open_in_tab' => 'Открыть',
            'saved_links_hint' => 'Не склеивайте несколько ссылок в одну строку — в параметре token должен быть только один URL. Используйте кнопки «Копировать URL» или отдельные ссылки.',
        ...
        'en' => [
            ...
            'saved_link_invoice' => 'Client invoice view:',
            'saved_link_portal' => 'Client portal:',
            'copy_link' => 'Copy URL',
            'open_in_tab' => 'Open',
            'saved_links_hint' => 'Do not merge several links into one line — the viewer token must be a single URL. Use Copy URL or each link separately.',
            'copied' => 'Link copied',
        ...
        'fi' => [
            ...
            'saved_link_invoice' => 'Lasku asiakkaalle (näkymä):',
            'saved_link_portal' => 'Asiakasportaali:',
            'copy_link' => 'Kopioi URL',
            'open_in_tab' => 'Avaa',
            'saved_links_hint' => 'Älä liitä useita linkkejä yhdeksi osoitteeksi — token-parametrissa on oltava vain yksi URL. Käytä Kopioi URL -painiketta tai linkkejä erikseen.',
